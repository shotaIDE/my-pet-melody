...
class SelectTemplateViewModel extends StateNotifier<SelectTemplateState> {
  SelectTemplateViewModel({
    required Stream<List<Template>> templatesStream,
  }) : super(const SelectTemplateState()) {
    _setup(templatesStream: templatesStream);
  }
  ...
  Future<void> _setup({required Stream<List<Template>> templatesStream}) async {
    _templatesSubscription = templatesStream.listen((templates) {
